...
* Prior to the Achiever stage, role-taking experiences can facilitate development,`[^1]`{=markdown} and the Co-Creator stage enjoys a variety of roles.`[^3]`{=markdown} Does the variety of engagements in consulting work provide these role-taking experiences?
...
`[^9]`{=markdown}: Including my profile, my estimate matched the profile four times, was mismatched by 0.5 stage five times, was mismatched by 1 stage one time, was mismatched by 1.5 stages two times, and was mismatched by 2 stages one time.
