...
Approaching the impacts as independent and isolated problems, solved by nation-states without shared [institutional decision-making](https://80000hours.org/problem-profiles/improving-institutional-decision-making/), can lead to dangerous unintended consequences.`[^2]`{=markdown}

The systems and complexity thinking in this report is the kind of thinking that comes with later `[adult development]({% post_url 2021-03-07-What-Is-Growing-Up %})`{=markdown} and requires a `[shifts in thinking]({% post_url 2021-03-14-Grown-Up-Thinking %})`{=markdown}. As we grow through the stages of adult development, we think in more complex, systemic, strategic, and interdependent ways.`[^3]`{=markdown} 
...
`	one-dimenstional --> multidimensional;`{=html}
`</div>`{=html}
...
`[^5]`{=markdown}: Stage names are from Joiner, W.B.; Josephs, S.A. *Leadership Agility: Five Levels of Mastery for Anticipating and Initiating Change*; 1st edition.; Jossey-Bass: San Francisco, 2006; [ISBN 978-0-7879-7913-3](https://isbn.nu/9780787979133).
`[^6]`{=markdown}: To generate these time spans I compared Jaques (1990)`[^4]`{=markdown} with Herdman-Barker, E. (2018). Structuring/Layering of Time & Space. Personal correspondence with Global Leadership Associates.
