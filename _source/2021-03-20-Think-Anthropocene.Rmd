...
The systems and complexity thinking in this report is the kind of thinking that comes with later [adult development]({% post_url 2021-03-07-What-Is-Growing-Up %}) and requires a [shifts in thinking]({% post_url 2021-03-14-Grown-Up-Thinking %}). As we grow through the stages of adult development, we think in more complex, systemic, strategic, and interdependent ways.`[^3]`{=markdown} 
...
samples_df <- read.csv(samples_path, stringsAsFactors = FALSE) %>%
  mutate(Description = paste0("N=", .$Count, " ", .$Country, " (", .$Start, ") ",
